	...
	<div class="container">
		<nav class="navbar row">
			<div class="navbar-header">
				<!--<a href="http://www.facebook.com/linayachninart/" class="icon-padding" target="_blank"><span class="fa fa-facebook icon-md pull-left"></span></a>--><a href="https://www.linkedin.com/in/lina-yachnin-54a9a28a" class="icon-padding" target="_blank"><span class="fa fa-linkedin icon-md pull-left"></span></a>
