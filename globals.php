<?php
	...
	$upcoming_text =
	'My recent show, <i>Connecté</i>, took place from October 16 - November 2 at <a href="http://www.galerieoldchelsea.ca" class="text-center" style="display: inline">Galerie Old Chelsea</a>.  Some paintings are still available at the Galerie.<br><br>The show was previewed in <i>The Low Down</i> earlier this month.<br><br><img src="img/Connecte_Article.jpg" alt="Artist\'s Trailblazing Leads to Connecté" class="img" height="700vh" width="auto"/>';
